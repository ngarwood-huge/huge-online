...
class mod_virtuemart_product_override {
	...
	static function addtocart ($product) {
		...
		if (!VmConfig::get ('use_as_catalog', 0)) {
			...
			<a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" class="addtocart-button btn btn-primary"><span><span><?php echo JText::_ ('COM_VIRTUEMART_CART_NOTIFY') ?></span></span></a>
				</div>
			<?php
			} else {
				?>
                ...
                <input name="quantity" type="hidden" value="<?php echo $step ?>" />
					...
					<script type="text/javascript">
                        ...
                        <?php // Display the quantity box 
											...
											<div class="form-group">
                                           <a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id); ?>" class="addtocart-button btn btn-primary select"><span><span><?php echo vmText::_ ('TM_VIRTUEMART_CART_SELECT') ?></span></span></a>
                                          </div>
                                        ...
                                        <?php
											...
											<a type="submit" name="addtocart" href="#" class="addtocart-button add btn btn-primary"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_CART_ADD_TO') ?></span></span></a>
                                            
										<?php } else { ?>
                                       		 <a type="submit" name="addtocart" href="#" class="addtocart-button btn btn-primary addtocart-button-disabled"><span><span><?php echo vmText::_ ('COM_VIRTUEMART_ADDTOCART_CHOOSE_VARIANT') ?></span></span></a>
										<?php } ?>
                                        </div>
