...
<div class="comment-box<?php echo $commentBoxIndentStyle; ?>">
	...
	<div class="panel-heading">	
		...
		<span class="comment-date"><i class="fa fa-calendar-o"></i> <?php echo JCommentsText::formatDate($comment->date, JText::_('DATETIME_FORMAT')); ?></span>
	</div>
...
<?php
	...
	function getCommentAdministratorPanel( &$comment )	{
		...
		<p class="toolbar pull-right" id="comment-toolbar-<?php echo $comment->id; ?>">
			<?php
	...
	function getCommentVote( &$comment ){
		...
		<span class="comments-vote">
			<span id="comment-vote-holder-<?php echo $comment->id; ?>">
				...
				<a href="#" class="vote-good" title="<?php echo JText::_('BUTTON_VOTE_GOOD'); ?>" onclick="jcomments.voteComment(<?php echo $comment->id;?>, 1);return false;"><i class="fa fa-thumbs-up"></i></a>
				<a href="#" class="vote-poor" title="<?php echo JText::_('BUTTON_VOTE_BAD'); ?>" onclick="jcomments.voteComment(<?php echo $comment->id;?>, -1);return false;"><i class="fa fa-thumbs-down"></i></a>
				<?php }
